...
{
    [Header("Drop Effect")] public float dropDuration = 0.5f; // Tempo para cair
    public float dropDistance = 1000f;
    [Header("Growth Settings")] public float growthTime = 10f; // Tempo total para crescer (após regar)

    [Header("References")] public Image plantImage; // O componente visual da planta
    ...
    public void SetVisualToGrown()
    {
        if (plantImage != null && plantData != null)
        {
